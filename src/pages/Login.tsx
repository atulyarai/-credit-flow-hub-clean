    ...
    <div className="h-screen w-full flex items-center justify-center bg-gradient-to-br from-app-darker to-app-dark p-4">
      <Card className="w-full max-w-md border-app-dark bg-app-dark/70 backdrop-blur-sm shadow-xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-3xl font-bold text-app-blue">CreditFlow</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center text-sm text-muted-foreground mt-4 p-3 bg-app-darker rounded-md border border-app-dark">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs">
                ...
                <div className="p-2 bg-app-dark/50 rounded">
                  <span className="block font-medium text-app-blue">Verifier</span>
                  verifier@example.com<br/>password
                </div>
                <div className="p-2 bg-app-dark/50 rounded">
                  <span className="block font-medium text-app-blue">Admin</span>
                  admin@example.com<br/>password
                </div>
              </div>
            </div>
          </form>
