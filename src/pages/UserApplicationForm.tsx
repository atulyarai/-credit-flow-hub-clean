            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="bg-app-darker border-app-dark text-white">
                      <SelectValue placeholder="Select loan type" />
                    </SelectTrigger>
                    <SelectContent className="bg-app-dark border-app-dark text-white">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-app-darker border-app-dark text-white placeholder:text-gray-400"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-white">
                  Loan Duration: {formData.duration} months
                </label>
                <Slider
                  defaultValue={[12]}
                  max={60}
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="min-h-[100px] bg-app-darker border-app-dark text-white placeholder:text-gray-400"
              ...
              <div className="flex justify-end gap-4">
                <Button
                  ...
                  className="border-app-dark text-white"
                >
                  Cancel
                </Button>
                <Button
                  type="submit"
                  className="bg-app-green hover:bg-app-light-green text-white"
